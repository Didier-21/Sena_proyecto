...
<head>
    ...
    <title>IE San José - Educación Rural de Calidad</title>
    ...
    <header class="hero min-vh-100 d-flex align-items-center bg-light">
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <img src="images/homeestudianterural.jpeg""/api/placeholder/600/400" alt="Estudiantes rurales" class="img-fluid rounded shadow">
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="container">
            ...
            <div class="row g-4 justify-content-center">
                <div class="col-md-3 col-sm-6">
                    <a href="https://rrhh.gestionsecretariasdeeducacion.gov.co/humanoEL/Ingresar.aspx?Ent=Valle/" target="_blank" class="card h-100 text-decoration-none text-dark hover-shadow">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="https://www.fomag.gov.co/" target="_blank" class="card h-100 text-decoration-none text-dark hover-shadow">
                        <div class="card-body text-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="https://www.icbf.gov.co/" target="_blank" class="card h-100 text-decoration-none text-dark hover-shadow">
                        <div class="card-body text-center">
                ...
                <div class="col-md-3 col-sm-6">
                    <a href="https://adenunciar.policia.gov.co/" target="_blank" class="card h-100 text-decoration-none text-dark hover-shadow">
                        <div class="card-body text-center">
            ...
            <div class="accordion" id="acordeonProyectos">
                ...
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#proyecto1">
                    ...
                    <div id="proyecto1" class="accordion-collapse collapse show" data-bs-parent="#acordeonProyectos">
                        <div class="accordion-body">
                            <p>El Proyecto de Cultivo de Hortalizas y Vegetales Orgánicos es una iniciativa integral diseñada para educar a los estudiantes en técnicas de agricultura sostenible, mientras se fomenta una conexión profunda con la naturaleza y el medio ambiente. Este proyecto se desarrolla en múltiples fases y tiene como objetivo principal capacitar a los estudiantes en la producción de alimentos saludables y ecológicos, promoviendo prácticas agrícolas responsables y respetuosas con el entorno..</p>
                        </div>
                    </div>
                </div>
                <!-- Proyecto 2 -->
                <div class="accordion-item">
                    ...
                    <div id="proyecto2" class="accordion-collapse collapse" data-bs-parent="#acordeonProyectos">
                        <div class="accordion-body">
                            <p>La producción avícola es una actividad agropecuaria que se enfoca en la cría y manejo de aves, principalmente pollos, pavos y gallinas, para la obtención de productos como carne y huevos. Este sector es vital para la seguridad alimentaria, ya que proporciona una fuente rica en proteínas y nutrientes esenciales. La producción avícola moderna utiliza tecnologías avanzadas para mejorar la eficiencia y sostenibilidad, incluyendo sistemas de alimentación automatizados, control ambiental y manejo sanitario. Además, promueve prácticas de bienestar animal y bioseguridad para garantizar la salud de las aves y la calidad de los productos finales, contribuyendo significativamente a la economía rural y la disponibilidad de alimentos saludables.</p>
                        </div>
                    </div>
                </div>
                <!-- Proyecto 3 -->
                <div class="accordion-item">
                    ...
                    <div id="proyecto3" class="accordion-collapse collapse" data-bs-parent="#acordeonProyectos">
                        <div class="accordion-body">
                            <p>El compostaje y la lombricultura son prácticas agroecológicas esenciales para el manejo sostenible de los residuos orgánicos y la mejora de la fertilidad del suelo. El compostaje es un proceso de descomposición controlada de materia orgánica, como restos de comida, hojas y desechos vegetales, que se transforma en un abono rico en nutrientes conocido como compost. Este proceso se lleva a cabo mediante la acción de microorganismos que descomponen la materia orgánica en condiciones aeróbicas, liberando nutrientes esenciales que mejoran la estructura y fertilidad del suelo, promoviendo el crecimiento saludable de las plantas.

                            La lombricultura, por su parte, es una técnica que utiliza lombrices, particularmente la lombriz roja californiana (Eisenia fetida), para descomponer los residuos orgánicos y producir humus de lombriz, un fertilizante natural de alta calidad. Las lombrices consumen la materia orgánica y excretan humus, un material rico en nutrientes como nitrógeno, fósforo, potasio y micronutrientes esenciales para las plantas. Además de mejorar la fertilidad del suelo, la lombricultura contribuye a la reducción de residuos sólidos urbanos y agrícolas, promoviendo un manejo más sostenible de los recursos.</p>
                        </div>
                    </div>
                </div>
                <!-- Práctica 1 -->
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#practica1">
                    ...
                    <div id="practica1" class="accordion-collapse collapse" data-bs-parent="#acordeonProyectos">
                        <div class="accordion-body">
                            <p>El análisis de suelos agrícolas es una práctica fundamental para la agricultura sostenible y el manejo eficiente de los recursos. Este procedimiento permite evaluar las propiedades físicas, químicas y biológicas del suelo, proporcionando información crítica para la toma de decisiones sobre fertilización, manejo de cultivos y mejora de la productividad.</p>
                        </div>
                    </div>
                </div>
                <!-- Práctica 2 -->
                <div class="accordion-item">
                    <h2 class="accordion-header">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#practica2">
                    ...
                    <div id="practica2" class="accordion-collapse collapse" data-bs-parent="#acordeonProyectos">
                        <div class="accordion-body">
                            <p>Las técnicas de reproducción y multiplicación de especies vegetales de interés agrícola son esenciales para mejorar la eficiencia y sostenibilidad de la producción agrícola. Entre estas técnicas se incluyen la propagación por semillas, el esquejado, el injerto y la micropropagación. La propagación por semillas es común para muchas plantas, permitiendo la generación de numerosas plántulas a partir de semillas viables. El esquejado implica el uso de segmentos de la planta madre para producir nuevas plantas, mientras que el injerto consiste en unir partes de dos plantas diferentes para combinar sus características deseadas. La micropropagación, una técnica avanzada de cultivo in vitro, permite la producción masiva de plantas a partir de tejidos vegetales en un ambiente controlado. Estas técnicas no solo aseguran la continuidad y calidad de las especies cultivadas, sino que también permiten la mejora genética y adaptación a condiciones ambientales cambiantes, aumentando la productividad y sostenibilidad agrícola.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 hover-shadow">
                        <img src= "images/homeprimaria.jpeg""/api/placeholder/300/200" class="card-img-top" alt="Primaria">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 hover-shadow">
                        <img src="images/homesecundaria.jpeg""/api/placeholder/300/200" class="card-img-top" alt="Secundaria">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 hover-shadow">
                        <img src="images/homegraduado.jpeg"/api/placeholder/300/200" class="card-img-top" alt="Técnico Agropecuario">
                        <div class="card-body">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="card h-100 hover-shadow">
                        <img src="images/homeproyectoespecial.jpeg"/api/placeholder/300/200" class="card-img-top" alt="Proyectos Especiales">
                        <div class="card-body">
