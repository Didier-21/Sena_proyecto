                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body p-5">
                        ...
                        <p class="lead text-muted">
                            ...
                            construcción de un ambiente educativo inspirador. Con una visión clara y un compromiso
                            inquebrantable,
                            lideran esfuerzos para transformar la educación y crear oportunidades para todos los
                            estudiantes.
                        </p>
                    </div>
                </div>
        ...
        <div class="row">
                        ...
                        <div class="teacher-image-container">
                            ...
                            <div class="teacher-overlay">
                                <div class="overlay-content">
                                    ...
                                    <p class="description">
                                        Comprometido con promover una educación inclusiva y de calidad, fomentando la
                                        innovación y el desarrollo integral de todos los estudiantes.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="teacher-card">
                    <div class="card border-0 shadow h-100">
                        <div class="teacher-image-container">
                            <img src="{{ asset('images/coordinadora.jpeg') }}" class="card-img-top"
                            ...
                            <div class="teacher-overlay">
                                <div class="overlay-content">
                                    ...
                                    <p class="description">
                                        Experta en metodologías activas y en el diseño curricular, trabaja para mejorar los
                                        procesos de enseñanza-aprendizaje en la institución.
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="teacher-card">
                    <div class="card border-0 shadow h-100">
                        <div class="teacher-image-container">
                            <img src="{{ asset('images/docenteorientadora.jpeg') }}" class="card-img-top"
                                alt="Docente Orientadora">
                            <div class="teacher-overlay">
                                <div class="overlay-content">
                                    ...
                                    <p class="description">
                                        Apasionada por el desarrollo integral de los estudiantes, brinda apoyo y
                                        asesoramiento para el crecimiento personal y académico.
                                    </p>
                                </div>
                            </div>
                        </div>
