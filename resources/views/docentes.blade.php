    ...
    <div class="row">
            ...
            <div class="teacher-card">
                <div class="card border-0 shadow h-100">
                    <div class="teacher-image-container">
                        <img src="{{ asset('images/doceagronomo.jpeg') }}" class="card-img-top" alt="Docente de Agronomía">
        ...
        <div class="col-md-3 mb-4">
            <div class="teacher-card">
                <div class="card border-0 shadow h-100">
                    <div class="teacher-image-container">
                        <img src="{{ asset('images/docetecno.jpeg') }}" class="card-img-top" alt="Docente de Tecnología">
                        <div class="teacher-overlay">
                            <div class="overlay-content">
        ...
        <div class="col-md-3 mb-4">
            <div class="teacher-card">
                <div class="card border-0 shadow h-100">
                    <div class="teacher-image-container">
                        <img src="{{ asset('images/docenbiologia.jpeg') }}" class="card-img-top" alt="Docente de Biología">
                        <div class="teacher-overlay">
                            <div class="overlay-content">
        ...
        <div class="col-md-3 mb-4">
            <div class="teacher-card">
                <div class="card border-0 shadow h-100">
                    <div class="teacher-image-container">
                        <img src="{{ asset('images/docentadmin.jpeg') }}" class="card-img-top" alt="Docente de Emprendimiento">
                        <div class="teacher-overlay">
                            <div class="overlay-content">
...
<div class="col-md-3 mb-4">
    <div class="teacher-card">
        <div class="card border-0 shadow h-100">
            <div class="teacher-image-container">
                <img src="{{ asset('images/doceciencias.jpeg') }}" class="card-img-top" alt="Docente de Ciencias">
                <div class="teacher-overlay">
                    <div class="overlay-content">
...
<div class="col-md-3 mb-4">
    <div class="teacher-card">
        <div class="card border-0 shadow h-100">
            <div class="teacher-image-container">
                <img src="{{ asset('images/docematema.jpeg') }}" class="card-img-top" alt="Docente de Matemáticas">
                <div class="teacher-overlay">
                    <div class="overlay-content">
                        ...
                        <p class="description">
                            ...
                            Fomenta el pensamiento lógico y analítico en sus estudiantes a través de métodos innovadores.
                        </p>
                    </div>
                </div>
            </div>
...
<div class="col-md-3 mb-4">
    <div class="teacher-card">
        <div class="card border-0 shadow h-100">
            <div class="teacher-image-container">
                <img src="{{ asset('images/doceespañol.jpeg') }}" class="card-img-top" alt="Docente de Lenguaje">
                <div class="teacher-overlay">
                    <div class="overlay-content">
                        ...
                        <p class="description">
                            ...
                            Inspira a sus estudiantes a desarrollar habilidades de lectura y escritura crítica.
                        </p>
                    </div>
                </div>
            </div>
...
<div class="col-md-3 mb-4">
    <div class="teacher-card">
        <div class="card border-0 shadow h-100">
            <div class="teacher-image-container">
                <img src="{{ asset('images/docehistoria.jpeg') }}" class="card-img-top" alt="Docente de Historia">
                <div class="teacher-overlay">
                    <div class="overlay-content">
                        ...
                        <p class="description">
                            ...
                            Utiliza narrativas y proyectos colaborativos para enseñar historia de manera dinámica.
                        </p>
                    </div>
                </div>
            </div>
