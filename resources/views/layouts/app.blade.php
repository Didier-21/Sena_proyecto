      ...
      <div class="modal-body">
        <form id="formularioMatricula" onsubmit="enviarFormulario(event)">
          ...
          <div class="mb-3">
            ...
            <select class="form-select" id="grado" name="grado" required onchange="mostrarOpcionesGrado()">
          ...
          <div class="mb-3">
            ...
            <input type="tel" class="form-control" id="telefonoAcudiente" name="telefonoAcudiente" required>
          </div>
          <div class="mb-3">
            <label for="emailAcudiente" class="form-label">Correo Electrónico</label>
            <input type="email" class="form-control" id="emailAcudiente" name="emailAcudiente" required>
          </div>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="https://www.valledelcauca.gov.co/documentos/12569/calendario-academico/" class="text-light text-decoration-none"><i class="fas fa-calendar-alt me-2"></i>Calendario Académico</a></li>
                        <li><a href="/gestion-juridica" class="text-light text-decoration-none"><i class="fas fa-user-graduate me-2"></i>Juridica</a></li>
                        <li><a href="https://consultas.bibliovalle.gov.co/cgi-bin/koha/opac-user.pl" class="text-light text-decoration-none"><i class="fas fa-book me-2"></i>Biblioteca Virtual</a></li>
                    </ul>
                </div>
